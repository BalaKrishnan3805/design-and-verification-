...
REM
REM Generated by Vivado on Sun Jul 27 17:53:24 +0530 2025
...
echo "xvlog --incr --relax -prj voting_machine_tb_vlog.prj"
call xvlog  --incr --relax -prj voting_machine_tb_vlog.prj -log xvlog.log
