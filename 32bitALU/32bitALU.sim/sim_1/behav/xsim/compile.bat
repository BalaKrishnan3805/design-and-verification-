...
REM
REM Generated by Vivado on Sun Jul 27 19:02:44 +0530 2025
...
echo "xvlog --incr --relax -prj tb_alu_32bit_vlog.prj"
call xvlog  --incr --relax -prj tb_alu_32bit_vlog.prj -log xvlog.log
